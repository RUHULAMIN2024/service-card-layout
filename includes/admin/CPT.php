...
class rasclCPT
{
	...
	function onInit()
	{
		...
		register_post_type('rascl', [
			'labels' => [
				'name'			=> __('ShortCodes', 'service-card-layout'),
				'singular_name'	=> __('ShortCode', 'service-card-layout'),
				'add_new'		=> __('Add New', 'service-card-layout'),
				'add_new_item'	=> __('Add New ShortCode', 'service-card-layout'),
				'edit_item'		=> __('Edit ShortCode', 'service-card-layout'),
				'new_item'		=> __('New ShortCode', 'service-card-layout'),
				'view_item'		=> __('View ShortCode', 'service-card-layout'),
				'search_items'	=> __('Search ShortCodes', 'service-card-layout'),
				'not_found'		=> __('Sorry, we couldn\'t find the ShortCode you are looking for.', 'service-card-layout')
			],
			'public' => true,
			'show_in_rest' => true,
			// "publicly_queryable" => false,
			'show_in_menu'			=> 'service-card-layout',
