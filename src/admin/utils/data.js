...
export const dashboardInfo = (info) => {
	...
	return {
		...
		description: 'Service Card Layout is a powerful and flexible block plugin that allows you to display posts, display blog posts, and embed custom posts in a fully customizable and responsive layout.',
		slug,
...
export const filterDemoInfo = {
	categories: [
		...
		{ label: 'Call To Actions', value: 'call-to-actions', col: 2, height: '350px' },
